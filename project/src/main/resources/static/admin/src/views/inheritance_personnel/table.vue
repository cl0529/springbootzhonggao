<template>
	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/inheritance_personnel/table','set') || $check_action('/inheritance_personnel/view','set') || $check_action('/inheritance_personnel/view','get') 
						" >
				...
				<template slot-scope="scope">
					...
					v-if="$check_action('/inheritance_personnel/table','set') || $check_action('/inheritance_personnel/view','set') || $check_action('/inheritance_personnel/view','get')"
						...
						<router-link v-if="$check_comment('/inheritance_personnel/table')" class="e-button el-button--small is-plain el-button--primary"
		...
		methods: {
			...
			get_list_before(param){
				...
				if(user_group != "管理员"){
						let sqlwhere = "(";
																				if(user_group=="传承用户"){
						sqlwhere+= "inheriting_users = " + this.user.user_id + " or ";
					}
