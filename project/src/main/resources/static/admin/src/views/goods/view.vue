		...
		<el-form ref="form" :model="form" status-icon label-width="70px">
			...
			<el-col :xs="24" :sm="24" :lg="24" v-show="!form.source_table" style="text-align: center;" class="el_form_btn_warp">
				...
				<el-button @click="cancel()">取消</el-button>
						...
						<!-- 文创商城 -->
			<diy_cultural_and_creative_mall v-if="form.source_table === 'cultural_and_creative_mall'" :query="{cultural_and_creative_mall_id:form.source_id}" :form_goods="form" :func_check="checkForm" :func_submit="submit" ></diy_cultural_and_creative_mall>
...
<script>
	import mixin from "../../mixins/page.js";
				import diy_cultural_and_creative_mall from "../../components/diy/diy_cultural_and_creative_mall.vue";
					
	export default {
		mixins: [mixin],
		components:{
						diy_cultural_and_creative_mall,
							},
		data() {
			return {
				field: "goods_id",
				...
				form: {
					...
					source_id: 0
							...
							"form_cultural_and_creative_mall": {},
