							...
							<div class="form_box">
								<b-form class="forms">
									...
									<form_ordinary_users v-if="form.user_group === '普通用户'" :form="form_sub"></form_ordinary_users>
											<!--传承用户-->
									<form_inheriting_users v-if="form.user_group === '传承用户'" :form="form_sub"></form_inheriting_users>
...
<script>
	...
	import form_ordinary_users from "@/components/diy/form_ordinary_users";
			/* 传承用户 */
	import form_inheriting_users from "@/components/diy/form_inheriting_users";
