				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<table_ordinary_users v-if="$check_action('/ordinary_users/table','get')"></table_ordinary_users>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_ordinary_users from "../../components/diy/table_ordinary_users.vue";
	export default {
		data() {
			return {
			};
