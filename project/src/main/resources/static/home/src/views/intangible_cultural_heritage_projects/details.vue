<template>
	<div class="diy_details page_intangible_cultural_heritage_projects" id="intangible_cultural_heritage_projects_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_intangible_cultural_heritage_projects'>
							<div_intangible_cultural_heritage_projects :obj="obj"></div_intangible_cultural_heritage_projects>
...
<script>
	import div_intangible_cultural_heritage_projects from "@/components/diy/div_intangible_cultural_heritage_projects.vue";
	...
	export default {
		...
		components:{
			...
			bar_title,
			form_editor,
			div_intangible_cultural_heritage_projects
		},
		data(){
			return{
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/intangible_cultural_heritage_projects/set?intangible_cultural_heritage_projects_id=' + obj["intangible_cultural_heritage_projects_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			async get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.intangible_cultural_heritage_projects_id;
														}
			},
													/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "intangible_cultural_heritage_projects",
					source_field: "intangible_cultural_heritage_projects_id",
					source_id: obj["intangible_cultural_heritage_projects_id"],
					user_id
				};
