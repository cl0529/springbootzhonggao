<template>
    <div class="list_link">
        ...
        <div class="row_link">
            <div v-for="(o, i) in list" :key="i" class="link_box">
                <a :href="o[vm.url]" class="link"> 
                    <div class="img_box">
                        <img
...
<style scoped>
    ...
    .link_title {
        height: 4rem;
        width: 15rem;
        background-color: rgba(180, 174, 174, 0.568);
        color: white;
        font-size: 1.5rem;
        display: flex;
        font-weight: bold;
    ...
    border-radius: 0.1rem 11px 11px 0px
    }
