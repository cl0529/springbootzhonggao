      ...
      <el-row class="rows row2">
         ...
         <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
                ...
                <el-button @click="reset()" style="margin-right: 74px;" class="search_btn_reset">重置</el-button>
                                                      <el-button v-if="$check_action('/intangible_cultural_heritage_projects/table','add') || $check_action('/intangible_cultural_heritage_projects/view','add')" @click="$router.push('./view?')" class="add">添加</el-button>
      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                ...
                <el-table-column fixed="right" label="操作" min-width="120" v-if="$check_action('/intangible_cultural_heritage_projects/table','set') || $check_action('/intangible_cultural_heritage_projects/view','set') || $check_action('/intangible_cultural_heritage_projects/view','get')
					 ">
      ...
      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
          ...
          <span>详情</span>
                                                                      ...
                                                                      <router-link v-if="$check_comment('/intangible_cultural_heritage_projects/table')" class="el-button el-button--small is-plain el-button--primary"
        ...
        this.showModal = false;
		  ...
		  get_list_after: function get_list_after(res, func, url) {
            ...
            if(user_group != "管理员"){
                                  let sqlwhere = "(";
                                                                                                                                                                                                                                                      if(user_group=="传承用户"){
                            sqlwhere+= "inheritance_personnel = " + this.$store.state.user.user_id + " or ";
                          }
