      ...
      <el-row class="rows row2">
         ...
         <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
                ...
                <el-button @click="reset()" style="margin-right: 74px;" class="search_btn_reset">重置</el-button>
                                                      <el-button v-if="$check_action('/cultural_and_creative_mall/table','add') || $check_action('/cultural_and_creative_mall/view','add')" @click="$router.push('./view?')" class="add">添加</el-button>
            <el-button v-if="$check_action('/cultural_and_creative_mall/table','del') || $check_action('/cultural_and_creative_mall/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
                        </el-col>
	    ...
	    <el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
          ...
          <el-table-column prop="cart_description" label="描述" min-width="200">
                                          ...
                                          <el-table-column prop="seller_customers" @sort-change="$sortChange" label="卖家用户"                                v-if="$check_field('get','seller_customers')" min-width="200">
                                      <template slot-scope="scope">
                      {{ get_user_seller_customers(scope.row['seller_customers']) }}
                                              ...
                                              <el-table-column prop="product_specifications" @sort-change="$sortChange" label="商品规格"                                v-if="$check_field('get','product_specifications')" min-width="200">
                                </el-table-column>
      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                ...
                <el-table-column fixed="right" label="操作" min-width="120" v-if="$check_action('/cultural_and_creative_mall/table','set') || $check_action('/cultural_and_creative_mall/view','set') || $check_action('/cultural_and_creative_mall/view','get')
					 ">
        

      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
                     v-if="$check_action('/cultural_and_creative_mall/table','set') || $check_action('/cultural_and_creative_mall/view','set') || $check_action('/cultural_and_creative_mall/view','get')"
                                 :to="'./view?' + field + '=' + scope.row[field]"
                                 size="small">
          <span>详情</span>
        </router-link>
                                                                      <router-link v-if="$check_comment('/cultural_and_creative_mall/table')" class="el-button el-button--small is-plain el-button--primary"
  ...
  export default {
    ...
    data() {
      return {
        ...
        showModal: false,
        // 获取数据地址
        url_get_list: "~/api/cultural_and_creative_mall/get_list?like=0",
        url_del: "~/api/cultural_and_creative_mall/del?",
        ...
        this.showModal = false;
		  ...
		  get_list_after: function get_list_after(res, func, url) {
            ...
            if(user_group != "管理员"){
                                  let sqlwhere = "(";
                                                                      if(user_group=="传承用户"){
                            sqlwhere+= "seller_customers = " + this.$store.state.user.user_id + " or ";
                          }
