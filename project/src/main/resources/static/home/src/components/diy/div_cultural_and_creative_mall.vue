<template>
	<div class="diy_details_box diy_div_cultural_and_creative_mall">
			...
			<div class="container">
				...
				<div class="row row_det">
						<div v-if="this.$store.state.user.user_id" class="btns_add col-12 col-sm-6">
							<div v-if="$check_action('/cultural_and_creative_mall/details','set')">
								<!-- 点赞按钮 -->
								<div
										v-if="state_praise"
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var cultural_and_creative_mall_id = this.obj.cultural_and_creative_mall_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "cultural_and_creative_mall",
          source_field: "cultural_and_creative_mall_id",
          source_id: cultural_and_creative_mall_id
        }, (res) => {
