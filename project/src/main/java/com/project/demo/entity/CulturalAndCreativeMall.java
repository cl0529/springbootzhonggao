...
/**
 * 文创商城：(CulturalAndCreativeMall)表实体类
 *
 */
@TableName("`cultural_and_creative_mall`")
@Data
@EqualsAndHashCode(callSuper = false)
public class CulturalAndCreativeMall implements Serializable {

    // CulturalAndCreativeMall编号
    @TableId(value = "cultural_and_creative_mall_id", type = IdType.AUTO)
    private Integer cultural_and_creative_mall_id;
